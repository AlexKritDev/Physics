...
const createSphere = (radius, position) => {
    ...
    world.addBody(body)
    objToUpd.push({mesh, body})
}

// const sphere1 = createSphere(.5, {x: 0, y: 3, z: 0})
// objToUpd.push(sphere1)
// createSphere(.4, {x: 1, y: 2, z: 1})
// const sphere2 = createSphere(1, {x: 0, y: 3, z: 0})
...
const tick = () => {
    ...
    //copy from CANNON.Vec3 doesnt provide Z axis! if world doesnt have 3d
